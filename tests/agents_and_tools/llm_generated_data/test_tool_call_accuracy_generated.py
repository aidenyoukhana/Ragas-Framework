"""
Test Tool Call Accuracy - Evaluation with LLM-Generated Data
"""
...
def test_tool_call_accuracy_generated_with_metrics(ragas_dataset):
    """
    Test Tool Call Accuracy metric with LLM-generated synthetic data.
    ...
    Note: ToolCallAccuracy requires MultiTurnSample format with tool calls,
    ...
    print("\n✅ Test passed: Tool Call Accuracy dataset generation successful")
