"""
Pytest configuration for LLM-generated test data in general_purpose_and_other_tasks tests.
Provides fixtures for generating synthetic test datasets using Ragas.
"""
...
def ragas_dataset():
    ...
    print("\n🚀 Generating synthetic test data for general purpose and other tasks...")
