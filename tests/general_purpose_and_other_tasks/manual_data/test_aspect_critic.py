"""
Test Aspect Critic - Evaluation with Metrics
"""
...
def test_aspect_critic_with_metrics(ragas_dataset):
    """Test Aspect Critic metric with actual evaluation and scoring."""
    ...
    print(f"\n🔍 Running Aspect Critic evaluation...")
    
    try:
        result = evaluate(dataset, metrics=[AspectCritic(name='helpfulness', definition='Is the response helpful?')], llm=llm)
