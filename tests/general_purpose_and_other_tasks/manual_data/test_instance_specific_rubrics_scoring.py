"""
Test Instance Specific Rubrics Scoring - Evaluation with Metrics
"""
...
def test_instance_specific_rubrics_scoring_with_metrics(ragas_dataset):
    """Test Instance Specific Rubrics Scoring metric with actual evaluation and scoring."""
    ...
    eval_data = {
        ...
        "answer": [],
        "contexts": [],
        "rubrics": [],  # Required for InstanceRubrics
    }
    ...
    for idx, sample in enumerate(ragas_dataset):
        ...
        rubrics = {
            "score1": "Is the answer accurate?",
            "score2": "Is the answer complete?"
        }
        
        eval_data["question"].append(question)
        eval_data["answer"].append(answer)
        eval_data["contexts"].append(contexts)
        eval_data["rubrics"].append(rubrics)
    ...
    print(f"\n🔍 Running Instance Specific Rubrics Scoring evaluation...")
    
    try:
        result = evaluate(dataset, metrics=[InstanceRubrics()], llm=llm)
        ...
        # Summary
        summary = f"\nInstance Specific Rubrics Scoring Evaluation:\n"
