"""
Test Rubrics Based Scoring - Evaluation with Metrics
"""
...
def test_rubrics_based_scoring_with_metrics(ragas_dataset):
    """Test Rubrics Based Scoring metric with actual evaluation and scoring."""
    ...
    print(f"\n🔍 Running Rubrics Based Scoring evaluation...")
    
    try:
        result = evaluate(dataset, metrics=[RubricsScore()], llm=llm)
        ...
        # Summary
        summary = f"\nRubrics Based Scoring Evaluation:\n"
