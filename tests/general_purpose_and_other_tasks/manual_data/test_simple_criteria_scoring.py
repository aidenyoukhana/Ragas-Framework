"""
Test Simple Criteria Scoring - Evaluation with Metrics
"""
...
def test_simple_criteria_scoring_with_metrics(ragas_dataset):
    """Test Simple Criteria Scoring metric with actual evaluation and scoring."""
    ...
    print(f"\n🔍 Running Simple Criteria Scoring evaluation...")
    
    try:
        result = evaluate(dataset, metrics=[SimpleCriteriaScore(name='accuracy', definition='Is the answer accurate?')], llm=llm)
        ...
        # Summary
        summary = f"\nSimple Criteria Scoring Evaluation:\n"
