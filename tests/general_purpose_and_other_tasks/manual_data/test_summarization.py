"""
Test Summarization - Evaluation with Metrics
"""
...
def test_summarization_with_metrics(ragas_dataset):
    """Test Summarization metric with actual evaluation and scoring."""
    ...
    eval_data = {
        ...
        "answer": [],
        "contexts": [],
        "reference_contexts": [],  # Required for summarization_score
    }
    ...
    try:
        result = evaluate(dataset, metrics=[summarization_score], llm=llm)
