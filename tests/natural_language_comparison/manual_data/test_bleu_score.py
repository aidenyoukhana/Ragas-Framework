"""
Test Bleu Score - Evaluation with Metrics
"""
...
def test_bleu_score_with_metrics(ragas_dataset):
    """Test Bleu Score metric with actual evaluation and scoring."""
    ...
    try:
        result = evaluate(dataset, metrics=[BleuScore()], llm=llm)
