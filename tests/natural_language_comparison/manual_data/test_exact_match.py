"""
Test Exact Match - Evaluation with Metrics
"""
...
def test_exact_match_with_metrics(ragas_dataset):
    """Test Exact Match metric with actual evaluation and scoring."""
    ...
    for idx, sample in enumerate(ragas_dataset):
        ...
        reference = f"Sample answer {idx + 1}"  # Reference answer for exact match
    ...
    try:
        result = evaluate(dataset, metrics=[ExactMatch()], llm=llm)
