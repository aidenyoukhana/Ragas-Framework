"""
Test Nonllm String Similarity - Evaluation with Metrics
"""
...
def test_nonllm_string_similarity_with_metrics(ragas_dataset):
    """Test Nonllm String Similarity metric with actual evaluation and scoring."""
    ...
    for idx, sample in enumerate(ragas_dataset):
        ...
        reference = f"Sample answer {idx + 1}"  # Reference for similarity comparison
    ...
    print(f"\n🔍 Running Nonllm String Similarity evaluation...")
    
    try:
        result = evaluate(dataset, metrics=[NonLLMStringSimilarity()], llm=llm)
        ...
        # Summary
        summary = f"\nNonllm String Similarity Evaluation:\n"
