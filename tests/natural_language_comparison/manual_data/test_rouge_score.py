"""
Test Rouge Score - Evaluation with Metrics
"""
...
def test_rouge_score_with_metrics(ragas_dataset):
    """Test Rouge Score metric with actual evaluation and scoring."""
    ...
    try:
        result = evaluate(dataset, metrics=[RougeScore()], llm=llm)
