"""
Test Semantic Similarity - Evaluation with Metrics
"""
...
def test_semantic_similarity_with_metrics(ragas_dataset):
    """Test Semantic Similarity metric with actual evaluation and scoring."""
    ...
    for idx, sample in enumerate(ragas_dataset):
        ...
        reference = f"Sample reference answer {idx + 1}"  # Reference for semantic similarity
    ...
    try:
        result = evaluate(dataset, metrics=[answer_similarity], llm=llm, embeddings=embeddings)
