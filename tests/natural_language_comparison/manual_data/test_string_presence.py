"""
Test String Presence - Evaluation with Metrics
"""
...
def test_string_presence_with_metrics(ragas_dataset):
    """Test String Presence metric with actual evaluation and scoring."""
    ...
    for idx, sample in enumerate(ragas_dataset):
        ...
        reference = "answer"  # String to check for presence
    ...
    print(f"\n🔍 Running String Presence evaluation...")
    
    try:
        result = evaluate(dataset, metrics=[StringPresence()], llm=llm)
