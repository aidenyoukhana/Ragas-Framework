"""
Test Answer Accuracy - Evaluation with Metrics
"""
...
def test_answer_accuracy_with_metrics(ragas_dataset):
    """Test Answer Accuracy metric with actual evaluation and scoring."""
    ...
    print(f"\n🔍 Running Answer Accuracy evaluation...")
    
    try:
        result = evaluate(dataset, metrics=[AnswerAccuracy()], llm=llm)
