"""
Test Response Groundedness - Evaluation with Metrics
"""
...
def test_response_groundedness_with_metrics(ragas_dataset):
    """Test Response Groundedness metric with actual evaluation and scoring."""
    ...
    print(f"\n🔍 Running Response Groundedness evaluation...")
    
    try:
        result = evaluate(dataset, metrics=[ResponseGroundedness()], llm=llm)
        ...
        # Summary
        summary = f"\nResponse Groundedness Evaluation:\n"
