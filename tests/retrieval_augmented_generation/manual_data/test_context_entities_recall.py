"""
Test Context Entities Recall - Evaluation with Metrics
"""
...
def test_context_entities_recall_with_metrics(ragas_dataset):
    """Test Context Entities Recall metric with actual evaluation and scoring."""
    ...
    print(f"\n🔍 Running Context Entities Recall evaluation...")
    
    try:
        result = evaluate(dataset, metrics=[context_entity_recall], llm=llm)
