"""
Test Faithfulness - Evaluation with Metrics
"""
...
def test_multimodal_faithfulness_with_metrics(ragas_dataset):
    """Test Faithfulness metric with actual evaluation and scoring."""
