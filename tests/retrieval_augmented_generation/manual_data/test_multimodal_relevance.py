"""
Test Multimodal Relevance - Evaluation with Metrics
"""
...
def test_multimodal_relevance_with_metrics(ragas_dataset):
    """Test Multimodal Relevance metric with actual evaluation and scoring."""
    ...
    try:
        result = evaluate(dataset, metrics=[multimodal_relevance], llm=llm)
        ...
        # Summary
        summary = f"\nMultimodal Relevance Evaluation:\n"
