"""
Test Noise Sensitivity - Evaluation with Metrics
"""
...
def test_noise_sensitivity_with_metrics(ragas_dataset):
    """Test Noise Sensitivity metric with actual evaluation and scoring."""
    ...
    print(f"\n🔍 Running Noise Sensitivity evaluation...")
    
    try:
        result = evaluate(dataset, metrics=[NoiseSensitivity()], llm=llm)
