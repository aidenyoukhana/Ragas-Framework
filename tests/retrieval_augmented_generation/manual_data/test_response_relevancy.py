"""
Test Response Relevancy - Evaluation with Metrics
"""
...
def test_response_relevancy_with_metrics(ragas_dataset):
    """Test Response Relevancy metric with actual evaluation and scoring."""
    ...
    # Initialize embeddings for answer_relevancy metric
    ...
    print(f"\n🔍 Running Response Relevancy evaluation...")
