"""
Test Datacompy Score - Evaluation with Metrics
"""
...
def test_datacompy_score_with_metrics(ragas_dataset):
    """Test Datacompy Score metric with actual evaluation and scoring."""
    ...
    print(f"\n🔍 Running Datacompy Score evaluation...")
    
    try:
        result = evaluate(dataset, metrics=[DataCompyScore()], llm=llm)
